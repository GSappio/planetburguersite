...
const porcoes = [
  ...
  },
  {
   ...
   {
    id: 3,
    nome: "Batata Cheddar Catupity e Bacon",
    descricao: "400g de batata frita perfeitamente crocante, coberta com uma generosa camada de cheddar e catupiry cremoso e pedaços crocantes de bacon. Uma combinação irresistível de sabores, perfeita para compartilhar ou saborear sozinho. Peça agora e transforme seu momento em uma explosão de sabor!",
    preco: 30,
    imagem: batataMediaCheddar,
    categoria: "porcoes",
    ativo: true
