...
const promocaoTurbo = [
  {
    id: 1,
    nome: 'X-Burguer Turbo - 6 UNIDADES',
    descricao:
      '6 unidades: Hambúrguer suculento com queijo cheddar derretido, servido no pão selado na chapa. Um clássico cheio de sabor e equilíbrio!',
    preco: 54,
    imagem: saladaTurbo,
    categoria: 'lanche',
    ativo: true,
  ...
  {
    id: 2,
    nome: 'X-Salada Turbo - 3 UNIDADES',
    descricao:
  ...
  {
    id: 3,
    nome: 'X-Calabresa Turbo - 3 UNIDADES',
    descricao:
  ...
  {
    id: 4,
    nome: 'X-Frango Turbo - 3 UNIDADES',
    descricao:
  ...
  {
    id: 6,
    nome: 'X-Frango Bacon Turbo - 3 UNIDADES',
    descricao:
  ...
  {
    id: 7,
    nome: 'X-Egg Bacon Turbo - 3 UNIDADES',
    descricao:
